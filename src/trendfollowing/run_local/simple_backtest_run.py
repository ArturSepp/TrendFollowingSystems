...
class Locals(Enum):
    """Runnable development cases."""

    SIMPLE_BACKTEST = 1


def run_local(local: Locals) -> None:
    """Run and report the packaged-universe European system backtest."""
    if local == Locals.SIMPLE_BACKTEST:
        ...
        # generate report
        qis.generate_strategy_factsheet(portfolio_data=system_portfolio,
                                        benchmark_prices=benchmark_prices)


if __name__ == '__main__':
    run_local(local=Locals.SIMPLE_BACKTEST)
